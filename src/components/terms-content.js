    ...
    <TermsContainer>
      ...
      <Section>
        <Container>
          <h2>Тарифы</h2>
          <p>
            Арендуйте бестселлеры и новинки в рамках одного из четырех тарифов.
            Тарифы различаются по длительности подписки &mdash; чем дольше
            подписка, тем выгоднее.
          </p>
          <PricingList>
            <li>
      ...
      <Section>
        <Container>
          ...
          <p>
            ...
            <a href="tel:+79374646007">+7 (937) 464-60-07</a>. Получатель: Очир
            Владимирович Л.
          </p>
        </Container>
      </Section>
